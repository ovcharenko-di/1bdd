...
Процедура Тест_ДолженПрочитатьФайлФичиСоСтроковымиПараметрами() Экспорт
	...
	Шаг0 = Шаги[0];
	Ожидаем.Что(Шаг0.Тело, "Ожидали, что найдем правильное тело шага 0, а это не так").Равно("я ничего не делаю строковый параметр ""ПарамСтрока""");
	Ожидаем.Что(Шаг0.Лексема, "Ожидали, что правильно нашли Шаг0.Лексема, а это не так").Равно(ВозможныеКлючевыеСлова.Когда);
	Ожидаем.Что(Шаг0.АдресШага, "Ожидали, что правильно нашли Шаг0.АдресШага, а это не так").Равно("ЯНичегоНеДелаюСтроковыйПараметр");
	...
	Шаг1 = Шаги[1];
	Ожидаем.Что(Шаг1.Тело, "Ожидали, что найдем правильное тело шага 1, а это не так").Равно("ничего не происходит строковый параметр 'ДругойПарамСтрока'");
	Ожидаем.Что(Шаг1.Лексема, "Ожидали, что правильно нашли Шаг1.Лексема, а это не так").Равно(ВозможныеКлючевыеСлова.Тогда);
	Ожидаем.Что(Шаг1.АдресШага, "Ожидали, что правильно нашли Шаг1.АдресШага, а это не так").Равно("НичегоНеПроисходитСтроковыйПараметр");
...
Процедура Тест_ДолженПрочитатьФайлФичиСКлючевымиСловамиШаговСоСтроковымиПараметрами() Экспорт
	...
	Шаг0 = Шаги[1];
	Ожидаем.Что(Шаг0.Тело, "Ожидали, что найдем правильное тело шага 0, а это не так").Равно("я ничего не делаю все параметры ""ПарамКогда""");
	Ожидаем.Что(Шаг0.Лексема, "Ожидали, что правильно нашли Шаг0.Лексема, а это не так").Равно(ВозможныеКлючевыеСлова.Когда);
	Ожидаем.Что(Шаг0.АдресШага, "Ожидали, что правильно нашли Шаг0.АдресШага, а это не так").Равно("ЯНичегоНеДелаюВсеПараметры");
	...
	Шаг2 = Шаги[2];
	Ожидаем.Что(Шаг2.Тело, "Ожидали, что найдем правильное тело шага 2, а это не так").Равно("никто ничего не делает все параметры ""ПарамИ""");
	Ожидаем.Что(Шаг2.Лексема, "Ожидали, что правильно нашли Шаг2.Лексема, а это не так").Равно(ВозможныеКлючевыеСлова.Также);
	Ожидаем.Что(Шаг2.АдресШага, "Ожидали, что правильно нашли Шаг2.АдресШага, а это не так").Равно("НиктоНичегоНеДелаетВсеПараметры");
	...
	Шаг3 = Шаги[3];
	Ожидаем.Что(Шаг3.Тело, "Ожидали, что найдем правильное тело шага 3, а это не так").Равно("ничего не происходит все параметры ""ПарамТогда""");
	Ожидаем.Что(Шаг3.Лексема, "Ожидали, что правильно нашли Шаг3.Лексема, а это не так").Равно(ВозможныеКлючевыеСлова.Тогда);
	Ожидаем.Что(Шаг3.АдресШага, "Ожидали, что правильно нашли Шаг3.АдресШага, а это не так").Равно("НичегоНеПроисходитВсеПараметры");
